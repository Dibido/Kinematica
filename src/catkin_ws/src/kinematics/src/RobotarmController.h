...
public:
   ...
   */
  void moveRobotarmToPosition(double aShapeAngle, Matrix<double, 3, 1> aConfiguration, double aGripperRotationDegree, double aGripperDegree, unsigned int aMoveTime, double aMoveTimeDelay);
